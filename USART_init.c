...
void USART_init(){
	...
	//sets communication mode to asynchronous, parity to whaterver the Pi team needs and stop bit to 2, with Data length to 8bits
	USARTE0_CTRLC = 0b00/*parity bit*/1011
